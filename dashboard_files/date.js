...
(function () {
  ...
  "use strict";
  var root = this;
  //var Date = _.clone(Date);
  var TmpDate = function() {
      this.hello ="hoo";k
      Date.apply(this, Array.prototype.slice.call(arguments));
      this.prototype = {};
  };
  //Date.prototype = previousDateMethods;
  ...
  timezoneJS.Date = function () {
    ...
    // Beginning DateJS hack
    // replacing this: if (typeof args[args.length - 1] === 'string' && isNaN(Date.parse(args[args.length - 1].replace(/GMT\+\d+/, '')))) {
    if (typeof args[args.length - 1] === 'string') {
        var lastArg = Date.parse(args[args.length - 1].replace(/GMT\+\d+/, ''));
